  ...
  describe 'ユーザー新規登録' do
    ...
    context "新規登録できないとき" do
      ...
      it "first_nameが空だと登録できない" do
        @user.first_name = " "
        @user.valid?
        expect(@user.errors.full_messages).to include("First name can't be blank", "First name must be full-width characters(Kanji,Hiragana,Katakana)")
      end
      it "last_nameが空だと登録できない" do
        @user.last_name = " "
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name can't be blank", "Last name must be full-width characters(Kanji,Hiragana,Katakana)")
      end
      ...
      it "first_name_kanaが空だと登録できない" do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("First name kana can't be blank", "First name kana must be full-width characters(Katakana)")
      end
      it "last_name_kanaが空だと登録できない" do
        @user.last_name_kana = " "
        @user.valid?
        expect(@user.errors.full_messages).to include("Last name kana can't be blank", "Last name kana must be full-width characters(Katakana)")
      end
