class FormBuy
  ...
  def save
    ...
    Shipping.create(zipcode: zipcode, prefecture_id: prefecture_id, city: city, house_number: house_number, building: building, telephone_number: telephone_number, buy_id: buy.id)
  end
